...
export const REAL_GIF_IDS: Record<string, string> = {
  ...
  'back-2-chinup': '1326',
  'back-3-lpullup': '3418',
  'back-1-superman': '0803',
  'back-2-lower-back-curl': '1352',
  'back-2-inverted-row-bench': '2298',
  'back-3-back-lever': '3297',
  // lower
  ...
  'warm-dyn-1-arm-circle': '1428',
  'warm-dyn-3-world-greatest': '1604',
  'warm-dyn-2-walking-lunge': '1688',
  'warm-dyn-1-dynamic-chest-stretch': '1167',
  'warm-dyn-2-chest-tap-pushup': '3216',
  'warm-dyn-1-standing-lateral-stretch': '0794',
  'warm-dyn-2-plank-twist': '0464',
  'warm-dyn-3-hanging-twist-raise': '0476',
  'warm-dyn-2-squat-overhead-twist': '1686',
  'warm-dyn-2-crab-twist-toe-touch': '1468',
  'warm-dyn-1-back-forth-step': '3672',
  'warm-dyn-1-ankle-circle': '1368',
  'warm-dyn-1-squat-overhead-reach': '1685',
  'warm-dyn-2-posterior-step-reach': '1687',
  'warm-dyn-1-half-knee-bend': '3221',
  'warm-dyn-2-runners-stretch': '1585',
  'warm-dyn-1-side-bend': '0002',
  'warm-dyn-2-russian-twist': '0687',
  'warm-dyn-2-hip-lift-twist': '1466',
  'warm-dyn-2-isometric-wipers': '0500',
  // cool-down
  ...
  // cool-up-2-chest ('Doorway Chest Stretch') has no confirmed real match —
  // id 1167 turned out to belong to a different exercise ('Dynamic Chest
  // Stretch', now warm-dyn-1-dynamic-chest-stretch above); a wrong demo is
  // worse than the built-in stick figure, so it's left unmatched.
  'cool-up-2-wrist': '0721',
  'cool-up-3-neck-front-back': '0462',
  'cool-up-3-neck-side': '0713',
  'cool-up-3-neck-rotation': '0716',
  'cool-up-1-back-pec-stretch': '1405',
  'cool-up-2-rear-deltoid-stretch': '0669',
  'cool-up-2-triceps-stretch': '0817',
  'cool-up-3-iron-cross-stretch': '1419',
  'cool-back-1-kneeling-lat-stretch': '1346',
  'cool-back-1-seated-lower-back-stretch': '0690',
  'cool-back-2-upper-back-stretch': '1365',
  'cool-back-1-sphinx': '1362',
  'cool-back-2-upward-dog': '1366',
  'cool-low-2-seated-glute-stretch': '1424',
  'cool-low-2-piriformis-stretch': '2567',
  'cool-low-2-side-quad-stretch': '0613',
  'cool-back-2-spine-stretch': '1363',
  'cool-back-2-bent-knee-twist': '3639',
  'cool-back-2-spine-twist-seated': '2329',
  'cool-back-1-pelvic-tilt': '1364',
  'cool-back-1-butterfly-pose': '1494',
};
...
export const STRENGTH_EXERCISES: StrengthExercise[] = [
  ...
  e(
    ...
    1,
    'cobra',
    'שכבו על הבטן עם ידיים מושטות קדימה ורגליים ישרות. הרימו בו-זמנית ידיים, חזה ורגליים מהרצפה תוך כיווץ הגב התחתון, והחזיקו לרגע למעלה.',
  ),
  e(
    'back-2-lower-back-curl',
    'כפיפת גב תחתון',
    'Lower Back Curl',
    'back',
    2,
    'bridge',
    'שכבו על הגב עם ברכיים כפופות. לחצו מרפקים ואמות לרצפה והשתמשו בהם כתמיכה כדי להרים את פלג הגוף העליון בקשת קלה, ואז הורידו בשליטה.',
  ),
  e(
    'back-2-inverted-row-bench',
    'חתירה אוסטרלית על ספסל',
    'Inverted Row on Bench',
    'back',
    2,
    'ytw',
    'הניחו ידיים על קצה ספסל נמוך ורגליים ישרות קדימה על הרצפה. משכו את החזה לכיוון הספסל תוך כיווץ השכמות, וחזרו למטה בשליטה.',
  ),
  e(
    'back-3-back-lever',
    'מנוף גב',
    ...
    3,
    'ytw',
    'תלו על מוט מתח והורידו את הגוף לתנוחה אופקית הפוכה מתחת למוט, כשהגב פונה לרצפה. תרגיל שליטה מתקדם הדורש כוח גב וליבה משמעותי.',
  ),
