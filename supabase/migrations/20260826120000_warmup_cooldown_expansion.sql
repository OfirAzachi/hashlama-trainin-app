-- Adds the new warm-up (dynamic_stretch) and cool-down exercises introduced
-- alongside their real ExerciseDB-matched GIFs (see REAL_GIF_IDS in
-- lib/strength-catalog.ts). Regenerated via scripts/dump-catalog.ts — reruns
-- the full insert with on conflict do nothing, so already-seeded rows are
-- left untouched and only the new ids land.
...
insert into public.strength_exercises (id, name, name_en, catalog, category, level, unit, units_per_rep, animation_key) values
  ...
  ('warm-dyn-1-dynamic-chest-stretch', 'מתיחת חזה דינמית', 'Dynamic Chest Stretch', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'ytw'),
  ('warm-dyn-2-chest-tap-pushup', 'שכיבת סמיכה עם טפיחת חזה', 'Chest Tap Push-Up', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'pushup'),
  ('warm-dyn-1-standing-lateral-stretch', 'מתיחת צד בעמידה', 'Standing Lateral Stretch', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'twist'),
  ('warm-dyn-2-plank-twist', 'פלאנק עם סיבוב', 'Front Plank With Twist', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'twist'),
  ('warm-dyn-3-hanging-twist-raise', 'הרמת רגליים בתלייה עם סיבוב', 'Hanging Straight Twisting Leg Hip Raise', 'warmup', 'dynamic_stretch', 3, 'reps', 1, 'ytw'),
  ('warm-dyn-2-squat-overhead-twist', 'סקוואט עם הושטה וסיבוב', 'Squat To Overhead Reach With Twist', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'squat'),
  ('warm-dyn-2-crab-twist-toe-touch', 'תנוחת סרטן עם נגיעה בבוהן', 'Crab Twist Toe Touch', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'twist'),
  ('warm-dyn-1-back-forth-step', 'צעד קדימה ואחורה', 'Back And Forth Step', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'stepup'),
  ('warm-dyn-1-ankle-circle', 'סיבובי קרסול', 'Ankle Circles', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'calf'),
  ('warm-dyn-1-squat-overhead-reach', 'סקוואט עם הושטה מעל הראש', 'Squat To Overhead Reach', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'squat'),
  ('warm-dyn-2-posterior-step-reach', 'מכרע אחורי עם הושטה', 'Posterior Step To Overhead Reach', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'lunge'),
  ('warm-dyn-1-half-knee-bend', 'חצאי כפיפות ברכיים', 'Half Knee Bends', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'squat'),
  ('warm-dyn-2-runners-stretch', 'מתיחת אצנים', 'Runners Stretch', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'lunge'),
  ('warm-dyn-1-side-bend', 'כפיפת צד 45 מעלות', '45° Side Bend', 'warmup', 'dynamic_stretch', 1, 'reps', 1, 'twist'),
  ('warm-dyn-2-russian-twist', 'סיבוב רוסי', 'Russian Twist', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'twist'),
  ('warm-dyn-2-hip-lift-twist', 'הרמת אגן עם סיבוב', 'Twist Hip Lift', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'bridge'),
  ('warm-dyn-2-isometric-wipers', 'מגבים איזומטריים', 'Isometric Wipers', 'warmup', 'dynamic_stretch', 2, 'reps', 1, 'legraise'),
  ...
  ('cool-low-2-seated-glute-stretch', 'מתיחת ישבן בישיבה', 'Seated Glute Stretch', 'cooldown', 'stretch_lower', 2, 'seconds', 5, 'plank'),
  ('cool-low-2-piriformis-stretch', 'מתיחת פיריפורמיס בישיבה', 'Seated Piriformis Stretch', 'cooldown', 'stretch_lower', 2, 'seconds', 5, 'plank'),
  ('cool-low-2-side-quad-stretch', 'מתיחת ירך קדמית בשכיבה על הצד', 'Lying Side Quads Stretch', 'cooldown', 'stretch_lower', 2, 'seconds', 5, 'sideplank'),
  ...
  ('cool-up-1-back-pec-stretch', 'מתיחת חזה מהגב', 'Back Pec Stretch', 'cooldown', 'stretch_upper', 1, 'seconds', 5, 'ytw'),
  ('cool-up-2-rear-deltoid-stretch', 'מתיחת כתף אחורית', 'Rear Deltoid Stretch', 'cooldown', 'stretch_upper', 2, 'seconds', 5, 'ytw'),
  ('cool-up-2-triceps-stretch', 'מתיחת תלת ראשי', 'Triceps Stretch', 'cooldown', 'stretch_upper', 2, 'seconds', 5, 'ytw'),
  ('cool-up-3-iron-cross-stretch', 'מתיחת צלב חזה', 'Iron Cross Stretch', 'cooldown', 'stretch_upper', 3, 'seconds', 5, 'cobra'),
  ...
  ('cool-back-1-kneeling-lat-stretch', 'מתיחת גב רחב בכריעה', 'Kneeling Lat Stretch', 'cooldown', 'stretch_back', 1, 'seconds', 5, 'cobra'),
  ('cool-back-1-seated-lower-back-stretch', 'מתיחת גב תחתון בישיבה', 'Seated Lower Back Stretch', 'cooldown', 'stretch_back', 1, 'seconds', 5, 'plank'),
  ('cool-back-2-upper-back-stretch', 'מתיחת גב עליון', 'Upper Back Stretch', 'cooldown', 'stretch_back', 2, 'seconds', 5, 'ytw'),
  ('cool-back-1-sphinx', 'תנוחת ספינקס', 'Sphinx', 'cooldown', 'stretch_back', 1, 'seconds', 5, 'cobra'),
  ('cool-back-2-upward-dog', 'תנוחת כלב פונה למעלה', 'Upward Facing Dog', 'cooldown', 'stretch_back', 2, 'seconds', 5, 'cobra'),
  ('cool-back-2-spine-stretch', 'מתיחת עמוד שדרה בישיבה', 'Spine Stretch', 'cooldown', 'stretch_back', 2, 'seconds', 5, 'plank'),
  ('cool-back-2-bent-knee-twist', 'פיתול ברכיים כפופות', 'Bent Knee Lying Twist', 'cooldown', 'stretch_back', 2, 'seconds', 5, 'twist'),
  ('cool-back-2-spine-twist-seated', 'פיתול עמוד שדרה', 'Spine Twist', 'cooldown', 'stretch_back', 2, 'seconds', 5, 'twist'),
  ('cool-back-1-pelvic-tilt', 'הטיית אגן בעמידה', 'Standing Pelvic Tilt', 'cooldown', 'stretch_back', 1, 'seconds', 5, 'bridge'),
  ('cool-back-1-butterfly-pose', 'תנוחת פרפר', 'Butterfly Yoga Pose', 'cooldown', 'stretch_back', 1, 'seconds', 5, 'plank'),
