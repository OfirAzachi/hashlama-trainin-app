        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            >
              ...
              {publish.isPending ? 'מפרסם…' : `פרסום ל-${participantCount} מתאמנים`}
            </button>
          </div>
        </div>
      ) : null}
          ...
          <Card className="card-pad space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  המתאמנים עובדים באינטרוול העבודה, ובמנוחה רושמים מה ביצעו. 40 / 20 הוא המבנה הסטנדרטי.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                { id: 'work', label: 'עבודה (שניות)', value: workSeconds, set: setWorkSeconds, step: 5 },
                { id: 'rest', label: 'מנוחה (שניות)', value: restSeconds, set: setRestSeconds, step: 5 },
              ].map((field) => (
            ...
            <p className="rounded-xl bg-elevated px-3 py-2 text-xs text-muted tnum">
              {roundsTotal} סבבים × ({workSeconds} + {restSeconds} שנ׳) ={' '}
              {Math.round((roundsTotal * (workSeconds + restSeconds)) / 60)} דקות עבודה
            </p>
          </Card>
            ...
            <dl className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl bg-elevated p-3">
                ...
                <dd className="text-sm text-ink tnum">
                  {roundsTotal} סבבים · {workSeconds} שנ׳ עבודה / {restSeconds} שנ׳ מנוחה
                </dd>
